...
- `02_Lab_journal.ipynb` - contains this whole pipeline done
...
📝 Also see pre-prepared [laboratory journal](https://github.com/iliapopov17/NGS-Handbook/blob/main/02_Genomic_Variation_Analysis/02_Lab_journal.ipynb)
